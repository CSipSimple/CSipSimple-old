...
%javamethodmodifiers pjsua_vid_enum_devs(pjmedia_vid_dev_info info[],
					 unsigned *count) "public synchronized";
%rename(vid_get_dev) pjsua_vid_get_dev;
%javamethodmodifiers pjsua_vid_get_dev(int *capture_dev, int *render_dev) "public synchronized";
%rename(vid_set_dev) pjsua_vid_set_dev;
%javamethodmodifiers pjsua_vid_set_dev(int capture_dev, int render_dev) "public synchronized";
%rename(vid_set_setting) pjsua_vid_set_setting;
%javamethodmodifiers pjsua_vid_set_setting(pjmedia_vid_dev_cap cap,
					   const void *pval,
					   pj_bool_t keep) "public synchronized";
%rename(vid_get_setting) pjsua_vid_get_setting;
%javamethodmodifiers pjsua_vid_get_setting(pjmedia_vid_dev_cap cap,
					   void *pval) "public synchronized";
