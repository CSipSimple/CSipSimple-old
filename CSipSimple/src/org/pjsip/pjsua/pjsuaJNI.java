...
public class pjsuaJNI {
  ...
  public final static native int vid_get_dev(int[] jarg1, long jarg2);
  public final static native int vid_set_dev(int jarg1, int jarg2);
  public final static native int vid_set_setting(long jarg1, byte[] jarg2, int jarg3);
  public final static native int vid_get_setting(long jarg1, byte[] jarg2);
